...
#        L3 —— AI 自动汇总，经人工「确认发布」后方可推送，不自动执行任何业务动作。
# ================================================================
...
Write-Host "   回滚     : schtasks /End /TN $TASK ; schtasks /Delete /TN $TASK /F ; 防火墙规则 Sc2-WebServer-$PORT 可留" -ForegroundColor DarkGray
Write-Host "   ⚠️ 仅 LAN（共享口令门禁）；L3 试用版，周报须人工「确认发布」后方可推送" -ForegroundColor Yellow
