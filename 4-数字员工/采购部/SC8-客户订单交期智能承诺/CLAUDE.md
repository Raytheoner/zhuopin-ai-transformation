...
- 🟡 C-1/C-2 替代料 DTO 真实字段验证 + 姚祖怡真实数据抽验（`sc8-baoguan-substitute-partial-kit`，2026-07-15 apply 时因无 LAN 访问未做，按假设实现）— 对客/正式启用前建议先做，非阻塞（当前实现零回归、mock 测试全过）。
