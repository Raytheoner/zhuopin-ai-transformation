...
#
# 🔴 **这两行是唯一开关。** 现值 ＝ 队列 #423 ⒜（孤立发票移出 KPI 三档、单列一条提示）。
#
# 🔴 **签认状态如实记载（2026-08-28 切换时写）**：本口径原属「判据/口径类，永不默认生效」
# （CLAUDE.md §5 IATF 显式签认红线），其权威来源是唐燕萍 2026-07-31 那份规格书 ⇒ 按规则
# 应由她显式签认后方可改动。**本次切换的依据是 Shao Peishen 2026-08-28 拍板，覆盖了该
# 显式签认要求；唐燕萍本人尚未签认，签认仍待补。** 记在这里是因为：IATF 可追溯要求的
# 是「谁批的、覆盖了什么」，而不是「有没有人批过」——把覆盖行为写清楚，比让它看起来
# 像一次正常签认更重要。
#
