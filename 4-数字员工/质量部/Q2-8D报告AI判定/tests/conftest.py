...
from q2_8d_verdict import feed_source
from q2_8d_verdict.engine import VerdictEngine
from q2_8d_verdict.rules_loader import load
...
@pytest.fixture(scope="session")
def samples():
    return {doc.report_id: (doc, exp) for doc, exp in feed_source.load_mock()}


@pytest.fixture
def engine(ruleset):
    return VerdictEngine(ruleset=ruleset)
