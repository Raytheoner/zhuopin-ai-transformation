"""opener 代码块 lint —— 一次收八个失效形态（队列 §一 `#284`／`#381`⑸ⓖ／`#487`，OP-0828-Y／OP-0904-A／OP-0905-C／OP-0906-I／OP-0909-X）。
...
## 八个形态（判据正本＝`1-转型规划/0-全景路线图/opener骨架.md`；判据说明＝`专线opener模板库.md` §〇.0／§〇.00）
...
def check_block(block: Block, *, is_subtask_lane: bool = False,
    ...
    """返回该块命中的 `(形态代码, 说明)` 列表。形态代码 ∈ {"F1".."F8", "C3", "C5"}。
