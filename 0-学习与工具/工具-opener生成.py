...
#: 🔴 措辞正本（队列 §一 `#553` ⑵，2026-09-11 更正）：此前写「主仓 ff 由 sweep 收尾段
#: 或看护者收工时串行做」，而 sweep 从不合任何泳道分支（对其全文 grep `claude/op`／
#: `泳道分支` 零命中）——**留给 sweep ＝ 留给没有人**。真做 ff 的只有两处：看护者收工
#: 串行，或 `工具-待合分支巡检.ps1` 按『已授权待合』登记处机器做。
SUBTASK_PUSH_NOTE = (
