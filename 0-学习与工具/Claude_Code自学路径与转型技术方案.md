...
| OpenSpec | ✅ **v1.7.0**（2026-08-02 升级，队列 #205-A；原 v1.4.1）<br>版本以 `环境依赖清单.md` 为准 | 全局 npm 安装 |
...
*文档版本：2026-06-10（修订；2026-08-02 仅更新工具链版本）| 工具链状态：SuperPowers v6.1.1 + **OpenSpec v1.7.0**（2026-08-02 升级，队列 #205-A）+ 全局记忆已配置——**版本单一可信源＝`0-学习与工具/环境依赖清单.md`，此处仅为提示** | 新增：配套实战补强 + 可跑练习册*
