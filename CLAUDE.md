...
---
**Last Updated**: 2026-07-06（财务域 v2：FI1 条件复启暂缓·全景 40 不变·7/15 门焦点转 FI2/FI3。同日前序：CC SC3/SC5 引擎迁移归档；采购 v2.3 重排（40 场景、采购 7）；§5 决策代理=孙涛/直读原则/开场词纪律；U9C 通道打通。更前序 2026-07-04 fsck 哨兵/专员跟进纪律）｜ 维护：本文件随架构/红线变更更新，时间线细节以实施计划第七节为准。
