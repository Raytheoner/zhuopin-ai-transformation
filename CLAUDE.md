...
- **阶段框架（命名 2026-06-13 定稿，见全景规划 §0.1）**：当前 18 个月（2026-07 → 2027-12）＝ **Phase 1**（底座 + 六部门流程提速 + 供应链/质量减负），内分 **S1 筑基期（2026-07~12）／S2 扩面期（2027-01~06）／S3 深化期（2027-07~12）**；部门内月度节奏用 M1/M2/M3，"第N阶段"称谓废止。**Phase 2 ＝ 产品工程跃升期（月 19-24 / 2028 H1）**：产品工程深化候选**统一 Phase-1 末（2027-12，底座稳定）评估立项、不并入 Phase 1、不打乱其排期**；候选清单见全景规划 "Phase 2 · 产品工程跃升期" 章节 ＋ `1-转型规划/0-全景路线图/AI候选场景增补-backlog（产品工程方向）.md`。⚠️ 场景数与 S3 性质**不在本行留副本**（正本＝全景规划 §加速启动总览排期表 ＋ §0.2；本行原写的「42 场景」「不并入 40」「S3＝显式规划缓冲」三处均已被 2026-08-21 v7 下架与 2026-08-18 v6 重排 ⑤ 推翻，2026-08-29 `OP-0829-E` 删副本、不在此改写口径）。
